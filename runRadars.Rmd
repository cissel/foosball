...
I got all my inspiration here: "https://www.kaggle.com/code/statsbymichaellopez/nfl-tracking-wrangling-voronoi-and-sonars" <- all the credit in the world goes to this human
...
# Import play by play data for each game from the 2022 season
...
runs22 <- nfl22 |> 
  ...
  mutate("runDir" = as.factor(paste(run_location, # create a new variable called "runDir" that 
                                    ifelse(run_location != "middle", # shows which direction 
                                           run_gap, # the run went
                                           ""), 
                                    sep = " "))) 
